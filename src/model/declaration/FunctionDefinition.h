...
namespace c4 {
    namespace model {
        namespace declaration {
            ...
            public:
                FunctionDefinition( std::shared_ptr<Pointer> ptr, std::shared_ptr<Declarator> dec, std::vector<std::shared_ptr<ParameterDeclaration>>& vec): ptr(ptr), dec(dec), vec(vec){}
